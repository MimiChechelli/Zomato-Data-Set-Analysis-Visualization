...
Para executar esse projeto de um clone no repositorio e o abra em sua ferramenta de notebooks favorita, instale as bibliotecas necessarias caso haja um arquivo requirements.txt e rode o arquivo zomato-data-set-analysis-visualization.ipynb.
